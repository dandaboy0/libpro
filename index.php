        ...
        <div class="box">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <input type="number" class="form-control border-dark" placeholder="Enter Tell Number"
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <input type="number" class="form-control border-dark" placeholder="your NIC Num" name="mnic"
                            id="mnic" required>
                    </div>
                    <div class="col-6">
                ...
                <div class="row">
                    ...
                    <div class="col-6"></div>
                    <div class="col-6">
                        <input type="date" class="form-control border-dark" name="mbdate" id="mbdate" required>
                    </div>
